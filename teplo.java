...
public class teplo extends javax.swing.JFrame
{
...
jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Теплоснабжение"));
...
.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
g.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
.addGroup(jPanel1Layout.createSequentialGroup()
...
layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
.addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE) /* добавление компонента jPanel1 
);
pack();
}
...
{
float sq = Float.parseFloat(jTextField2.getText());
float tarif = Float.parseFloat(jTextField3.getText());
float result = sq*tarif;
...
{ 
java.util.logging.Logger.getLogger(teplo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
} 
