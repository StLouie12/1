...
public class electro extends javax.swing.JFrame
{
...
jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Электроснабжение"));
...
jButton8.setText("8"); jButton8.addActionListener(new java.awt.event.ActionListener()
{
public void actionPerformed(java.awt.event.ActionEvent evt)
{
...
float kilovat = Float.parseFloat(jTextField2.getText());
float tarif =  Float.parseFloat(jTextField3.getText()); 
float result = kilovat*tarif;
...
{ 
java.util.logging.Logger.getLogger(electro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
} 
